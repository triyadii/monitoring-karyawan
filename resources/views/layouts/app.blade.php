...
<base href="../" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">@yield('title', 'Dashboard')</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
		...
		<script>
			...
			// Global interceptor for jQuery AJAX (e.g., DataTables)
			if (typeof $ !== 'undefined') {
				$.ajaxSetup({
					statusCode: {
						401: function() {
			...
			document.addEventListener('DOMContentLoaded', function () {
				...
				try {
					const userData = JSON.parse(userDataStr);
					document.getElementById('user_profile_name').innerText = userData.nama;
					document.getElementById('user_profile_username').innerText = userData.username;
					
					// Role-based logic (menus are handled instantly in <head> to prevent flickering)
					let rawRole = userData.role_name || (userData.role && userData.role.nama_role) || '';
					const roleName = rawRole.toLowerCase();

					const statusBadge = document.getElementById('user_profile_status');
					if (userData.status === 1) {
						statusBadge.innerText = 'Active';
						statusBadge.className = 'badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2';
					} else {
						statusBadge.innerText = 'Inactive';
						statusBadge.className = 'badge badge-light-danger fw-bold fs-8 px-2 py-1 ms-2';
					}
				} catch (e) {
					console.error("Error parsing user data", e);
				}

				document.getElementById('sign_out_button').addEventListener('click', function(e) {
					e.preventDefault();
					localStorage.removeItem('jwt_token');
					localStorage.removeItem('user_data');
					window.location.href = '/login';
